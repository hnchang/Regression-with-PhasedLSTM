...
class PhasedLSTM(Recurrent):
    ...
    def build(self, input_shape):
        ...
        self.recurrent_kernel = self.add_weight(shape = 
        ...
        # time-gate
        self.timegate_kernel = self.add_weight(shape = 
            (3, self.units),
    ...
    def step(self, inputs, states):
        ...
        mid = K.cast(K.less_equal(phi, r_on), K.floatx()) * K.cast(K.greater(phi, r_on * 0.5), K.floatx()) * (2 - (2 * phi / r_on))
